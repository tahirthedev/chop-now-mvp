            ...
            <div className="border-4 border-dashed border-gray-200 rounded-lg h-96 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Manage your restaurant, menu items, and incoming orders.
                </p>
                <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow">
                    ...
                    <p className="text-gray-600 mt-2">Process incoming orders and manage kitchen workflow</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow">
                    <h3 className="text-lg font-medium text-gray-900">Analytics</h3>
                    <p className="text-gray-600 mt-2">Track sales, popular items, and performance</p>
                  </div>
                </div>
              </div>
            </div>
